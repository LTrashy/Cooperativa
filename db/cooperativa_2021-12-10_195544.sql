...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3 COMMENT='tabla aportes';
...
INSERT INTO `aportes` VALUES (6,4,500000,'2021-12-09 13:27:43'),(7,4,100000,'2021-12-09 14:03:49');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COMMENT='tabla asociados';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `asociados` VALUES (4,9,'2021-12-01 00:00:00',100);
...
CREATE TABLE `permisos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3 COMMENT='tabla permisos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `permisos` VALUES (1,'',1),(2,'login',1),(3,'signup',1),(4,'dashboard',1),(5,'user',1),(6,'admin',1),(7,'aporte',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COMMENT='tabla personas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `personas` VALUES (1,1001270312,'Anderson Gonzalez Forero ','calle 69a sur# 17n 76',3197454533,'ander@gmail.com','2001-03-29'),(9,12345,'','',0,'',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3 COMMENT='tabla relacional roles-permisos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles_permisos` VALUES (1,1,1),(2,1,2),(3,1,3),(4,2,4),(5,2,5),(6,3,6),(7,2,7);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COMMENT='tabla relacional user-rol';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_roles` VALUES (1,2,1),(3,2,4);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COMMENT='users TABLE';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,1,'2021-11-24 00:00:00','trashy','$2y$10$hA2fHlX1D/YxnPIQn3OKRusTXv6b47deMq/c5/JM.MaO/Yj1ds7gm'),(4,9,'2021-12-01 00:00:00','steven','$2y$10$SwP6j1bIrqpTnrtvhYOTIuyL4uCiP1961Y4F2kfYvgdryfrC6L1XG');
...
-- Dump completed on 2021-12-10 19:56:04
