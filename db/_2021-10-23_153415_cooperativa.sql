...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COMMENT='tabla aportes';
...
CREATE TABLE `creditos` (
  ...
  `valor_cuota` bigint NOT NULL COMMENT 'valor de la cuota',
  PRIMARY KEY (`id`),
  KEY `creditos` (`id_asociado`),
  CONSTRAINT `creditos_ibfk_1` FOREIGN KEY (`id_asociado`) REFERENCES `asociados` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3 COMMENT='tabla creditos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8mb3 COMMENT='tabla cuotas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-10-23 15:34:38
